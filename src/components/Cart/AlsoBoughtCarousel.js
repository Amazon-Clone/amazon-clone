    ...
    render() {
        ...
        return (
            <div className='also-bought-car'>
                <div className='carousel-title'><h1 className='halfway'>Customers Who Bought Items in Your Recent History Also Bought</h1><h6 className='little-righty'>Page 1 of 6</h6></div>
