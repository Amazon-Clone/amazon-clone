SELECT queryA.optionId, queryA.productName, queryA.optionName, queryA.productBrand, queryA.productPrime, queryA.productFreeShipping, jsonb_object_agg(OptionSpecs.optionSpecName, OptionSpecs.optionSpecText), queryA.optionImageUrl, queryA.optionDimensions, queryA.optionWeight, queryA.optionLastPrice, queryA.optionPrice FROM
